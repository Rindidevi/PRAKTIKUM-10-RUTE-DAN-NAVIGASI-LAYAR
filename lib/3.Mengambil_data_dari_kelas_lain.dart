...
class FirstScreen extends StatelessWidget {
  ...
  // Fungsi untuk memanggil layar kedua dan menunggu hasilnya.
  panggilSecondScreen(BuildContext context) async {
    final _result = await Navigator.push(
      context,
      MaterialPageRoute(
        builder: (BuildContext context) {
          return const SecondScreen(); // Menampilkan SecondScreen.
        },
      ),
    );
    print('Datanya adalah: $_result'); // Mencetak data yang diterima dari SecondScreen.
  }
    ...
    return Scaffold(
      ...
      body: Center(
        child: ElevatedButton(
          ...
          onPressed: () {
            // Memanggil layar kedua dan menunggu hasilnya.
    ...
    return Scaffold(
      ...
      body: Center(
        child: ElevatedButton(
          ...
          onPressed: () {
            // Menghapus layar ini dari stack navigasi dan mengirim data 2020.
